            ...
            ((h.prototype.initConsentSDK = function () {
                ...
                (h.prototype.setDomainIfBulkDomainEnabled = function (t) {
                    ...
                    e &&
                        ...
                        ((e = window.sessionStorage) && e.getItem("bulkDomainMgmtEnabled")
                            ...
                            : ((n = { location: p.storageBaseURL.replace(/^https?:\/\//, ""), domainId: this.domainId, url: i }), this.otFetch(a, this.handleBulkDomainMgmt, !1, n, t)));
                }),
                (h.prototype.getLocation = function (t) {
                    ...
                    i.OneTrust && i.OneTrust.geolocationResponse
                        ? ((i = i.OneTrust.geolocationResponse), this.setGeoLocation(i.countryCode, i.stateCode), this.addBannerSDKScript(t))
                ...
                (h.prototype.setOTDataLayer = function () {
                    ...
                    this.otDataLayer = { ignore: (e && "true" === t) || (e && "" === t), name: p.stubScriptElement.getAttribute("data-dLayer-name") || "dataLayer" };
                }),
                ...
                (h.prototype.otFetch = function (t, i, e, n, a) {
                    ...
                    if (new RegExp("^file://", "i").test(t)) this.otFetchOfflineFile(t, i);
                        ...
                        if (
                            ((s.onload = function (t) {
                                var e;
                                this && (e = '{"CookieSPAEnabled":false,"CookieSameSiteNoneEnabled":false,"CookieV2CSPEnabled":false,"MultiVariantTestingEnabled":false,"UseV2":true,"MobileSDK":false,"SkipGeolocation":false,"ScriptType":"PRODUCTION","Version":"202401.2.0","OptanonDataJSON":"09f1c894 - 2c3f - 4626 - 977c - 910163434b5b","GeolocationUrl":"https://geolocation.onetrust.com/cookieconsentpub/v1/geo/location","BulkDomainCheckUrl":"https://cookies-data.onetrust.io/bannersdk/v1/domaingroupcheck","RuleSet":[{"Id":"018ee5c0-715f-7974-a8ed-c811ab4256f4","Name":"Global","Countries":["pr","ps","pw","py","qa","ad","ae","af","ag","ai","al","am","ao","aq","ar","as","au","aw","az","ba","bb","rs","bd","ru","bf","rw","bh","bi","bj","bl","bm","bn","bo","sa","sb","bq","sc","br","bs","sd","bt","sg","bv","sh","bw","sj","by","bz","sl","sn","so","ca","sr","cc","ss","st","cd","cf","sv","cg","sx","ch","ci","sy","sz","ck","cl","cm","cn","co","cr","tc","td","cu","tf","tg","cv","cw","th","cx","tj","tk","tl","tm","tn","to","tr","tt","tv","tw","tz","dj","dm","do","ua","ug","dz","um","ec","us","eg","eh","uy","uz","va","er","vc","ve","et","vg","vi","vn","vu","fj","fk","fm","fo","wf","ga","gb","ws","gd","ge","gg","gh","gi","gl","gm","gn","gq","gs","gt","gu","gw","gy","xk","hk","hm","hn","ht","ye","id","il","im","in","io","za","iq","ir","zm","je","zw","jm","jo","jp","ke","kg","kh","ki","km","kn","kp","kr","kw","ky","kz","la","lb","lc","lk","lr","ls","ly","ma","md","me","mg","mh","mk","ml","mm","mn","mo","mp","mr","ms","mu","mv","mw","mx","my","mz","na","nc","ne","nf","ng","ni","np","nr","nu","nz","om","pa","pe","pf","pg","ph","pk","pm","pn"],"States":{},"LanguageSwitcherPlaceholder":{"default":"tr"},"BannerPushesDown":false,"Default":true,"Global":true,"Type":"GENERIC","UseGoogleVendors":false,"VariantEnabled":false,"TestEndTime":null,"Variants":[],"TemplateName":"WEG TR","Conditions":[],"GCEnable":false,"IsGPPEnabled":false,"EnableJWTAuthForKnownUsers":false}],"IabData":{"cookieVersion":"1","createdTime":"2024-05-31T11:03:33.230036553","updatedTime":"2024-05-31T11:03:33.230049553","cmpId":"28","cmpVersion":"1","consentScreen":"1","consentLanguage":null,"vendorListVersion":0,"maxVendorId":0,"encodingType":"0","globalVendorListUrl":"https://cdn.cookielaw.org/vendorlist/iabData.json"},"IabV2Data":{"cookieVersion":"1","createdTime":"2024-05-31T11:03:33.280877051","updatedTime":"2024-05-31T11:03:33.280891331","cmpId":"28","cmpVersion":"1","consentScreen":"1","consentLanguage":null,"vendorListVersion":0,"maxVendorId":0,"encodingType":"0","globalVendorListUrl":"https://cdn.cookielaw.org/vendorlist/iab2Data.json"},"Iab2V2Data":{"cookieVersion":"1","createdTime":"2024-05-31T11:03:33.331881669","updatedTime":"2024-05-31T11:03:33.331897469","cmpId":"28","cmpVersion":"1","consentScreen":"1","consentLanguage":null,"vendorListVersion":0,"maxVendorId":0,"encodingType":"0","globalVendorListUrl":"https://cdn.cookielaw.org/vendorlist/iab2V2Data.json"},"GoogleData":{"vendorListVersion":1,"googleVendorListUrl":"https://cdn.cookielaw.org/vendorlist/googleData.json"},"ScriptDynamicLoadEnabled":false,"TenantFeatures":{"CookieV2BannerFocus":true,"CookieV2RejectAll":true,"CookieV2GPC":true,"CookieV2AssignTemplateRule":true,"MobileAuthenticatedConsents":true,"CookieV2GeolocationJsonApi":true,"CookieV2GCMDMA":true,"CookieV2TCF21":true,"CookieV2RemoveSettingsIcon":true,"CookieV2BannerLogo":true,"CookieV2GeneralVendors":true,"CookieV2GPP":true},"IsSuppressBanner":false,"IsSuppressPC":false,"PublisherCC":"DE","Domain":"enuygun.com","TenantGuid":"f9991df8-3ec5-482a-961b-de0d1dcf97cd","EnvId":"app-de-prod","RemoteActionsEnabled":false,"GeoRuleGroupName":"KVKK","GATrackToggle":false,"GATrackAssignedCategory":"","WebFormIntegrationEnabled":false,"WebFormSrcUrl":"","WebFormWorkerUrl":"","GppData":{"cmpId":"28"},"AuthenticatedConsent":false}'), a ? i(JSON.parse(e), a) : i(JSON.parse(e));
                            }),
                                (s.onerror = function () {
                                    i();
                                }),
                    ...
                    var n,
                        ...
                        s =
                            (this.otDataLayer.ignore || void 0 === o[this.otDataLayer.name]
                                ...
                                : o[this.otDataLayer.name].constructor === Array && (o[this.otDataLayer.name].push({ OnetrustActiveGroups: a }), o[this.otDataLayer.name].push({ OptanonActiveGroups: a })),
                ...
                (h.prototype.setStubScriptElement = function () {
                    ...
                    p.stubScriptElement && p.stubScriptElement.hasAttribute(p.DATAFILEATTRIBUTE)
                        ...
                        : t
                            ? (this.domainId = t)
                            : p.stubScriptElement || ((p.stubScriptElement = document.querySelector("script[src*='" + p.migratedCCTID + "']")), p.stubScriptElement && ((p.isMigratedURL = !0), (this.domainId = p.migratedDomainId.trim())));
                }),
                ...
                (h.prototype.updateVersion = function (t) {
                    ("debug" !== this.buildType && "cybuild" !== this.buildType) || (t.Version = "202407.2.0");
                }),
                h);
    function h() {
        var s = this;
        (this.iabType = null),
            ...
            (this.getConsentDataRequest = function (t) {
                t && p.IABCookieValue && t({ gdprApplies: p.oneTrustIABgdprAppliesGlobally, hasGlobalScope: p.hasIABGlobalScope, consentData: p.IABCookieValue }, !0);
            }),
            this.initConsentSDK();
    }
    var g = new m();
